...
const DATA = {
  ...
  prep: {
    ...
    note: {
      kr:"수업 주말 전에 끝내야 하는 것은 **FNCE Quiz #1(9/10 마감)** 과 **LGST 리딩 8건** 두 가지입니다. 퀴즈는 **시도 3회 · 최고점 반영 · 정오답 확인 가능**으로 바뀌어 사실상 학습 도구가 됐습니다. 아래 카드는 **수업 전에 끝낼 것 → 수업 당일 진행되는 것** 순서입니다.",
      en:"Two things have to be done before the class weekend: **FNCE Quiz #1 (due Sep 10)** and the **eight LGST readings**. The quiz now allows **three attempts, keeps the highest score, and shows which answers were right**, so treat it as a study tool. The cards below run **from what to finish beforehand to what happens in class**.",
      cn:"上课周末前必须完成的是 **FNCE Quiz #1(9/10 截止)** 与 **LGST 八篇阅读**。测验已改为**可考3次 · 取最高分 · 可查看对错**,实为学习工具。下方卡片按**课前须完成 → 课堂当天进行**的顺序排列。" },
    cards: [
      {
        course:"FNCE 6130", color:"#8ea2ff", flag:true,
        when:{ kr:"지금 → 9/10(목) 23:59 PT", en:"Now → Thu Sep 10, 11:59 PM PT", cn:"现在 → 9/10(周四)23:59 PT" },
        badge:{ kr:"시도 3회", en:"3 attempts", cn:"可考3次" },
        lines:[
          { icon:"🔴", text:{ kr:"**Quiz #1 · 15점** — 범위는 **거시경제 데이터 + 생산과 경제성장** (8/28·8/29 두 세션)",
                              en:"**Quiz #1, 15 points** — covering **macroeconomic data and production/economic growth** (the Aug 28 and Aug 29 sessions)",
                              cn:"**Quiz #1 · 15分** — 范围为**宏观经济数据 + 生产与经济增长**(8/28、8/29 两节课)" },
                     sub:{ kr:"퀴즈는 4회 중 **best 3**만 성적에 반영됩니다", en:"Only the **best 3 of 4 quizzes** count toward the grade", cn:"4次测验中**取最佳3次**计入成绩" } },
          { icon:"⭐", text:{ kr:"**1차는 그냥 풀어보세요.** 최고점만 반영되니 첫 점수는 버려도 됩니다",
                              en:"**Just take attempt 1 cold.** Only the highest score counts, so the first result is disposable",
                              cn:"**第一次直接试做即可。** 只取最高分,首次成绩可弃" },
                     sub:{ kr:"오답 확인 → 약한 곳 학습 → 2·3차. 이게 규칙 변경의 취지입니다", en:"Review what you missed, study the gaps, then attempt 2 and 3 — that is the point of the change", cn:"查看错题 → 补强弱项 → 再考2、3次。这正是规则变更的用意" } },
          { icon:"🤖", text:{ kr:"**생성형 AI 와 팀 협업 모두 허용**입니다", en:"**Generative AI and team collaboration are both allowed**", cn:"**允许使用生成式 AI 与团队协作**" },
                     sub:{ kr:"교수 원문 — *\"답이 아니라 힌트나 설명을 물으세요. 시험장에는 AI 가 없습니다.\"*", en:"His words — *\"ask for a hint or an explanation, not the answer. You will not have AI in the exam.\"*", cn:"教授原话 — *\"请询问提示或解释,而非答案。考试时不会有 AI。\"*" } },
        ],
      },
      {
        course:"LGST 6120", color:"#c9a0ff", flag:true,
        when:{ kr:"지금 → 9/11(금) 수업 전", en:"Now → before class Fri Sep 11", cn:"现在 → 9/11(周五)课前" },
        badge:{ kr:"리딩 8건", en:"8 readings", cn:"8篇阅读" },
        lines:[
          { icon:"📚", text:{ kr:"**8/31~9/2 에 리딩 8건이 한꺼번에 올라왔습니다** — Canvas ▸ Files",
                              en:"**Eight readings were posted between Aug 31 and Sep 2** — Canvas ▸ Files",
                              cn:"**8/31~9/2 一次性上传了8篇阅读** — Canvas ▸ Files" },
                     sub:{ kr:"판례 4건(`Dodge v Ford` · `Dirks v SEC` · `Williams v. Walker-Thomas` · `FTC v. Amazon`) + `Packer - A Dirty Business`(9/2 최신) · `Pershing's Expedition` · `Exit Interview` · `Spinning Wheels`",
                            en:"Four cases (`Dodge v Ford`, `Dirks v SEC`, `Williams v. Walker-Thomas`, `FTC v. Amazon`) plus `Packer - A Dirty Business` (newest, Sep 2), `Pershing's Expedition`, `Exit Interview`, `Spinning Wheels`",
                            cn:"判例4件(`Dodge v Ford`、`Dirks v SEC`、`Williams v. Walker-Thomas`、`FTC v. Amazon`)及 `Packer - A Dirty Business`(9/2 最新)、`Pershing's Expedition`、`Exit Interview`、`Spinning Wheels`" } },
          { icon:"📝", text:{ kr:"**수업 주말에 조원과 발표 주제를 정해 두세요** — 제출 마감이 **9/16(수) 17:00 PT**",
                              en:"**Settle the presentation topic with your group over the class weekend** — it is due **Wed Sep 16, 5 PM PT**",
                              cn:"**请在上课周末与组员敲定展示主题** — 截止为 **9/16(周三)17:00 PT**" },
                     sub:{ kr:"조 대표 1명이 후보 2~3개를 각 한 문장 + 순위로 교수에게 메일 · 교수 안내가 **9월 초 브레인스토밍**이라 이번 주말이 유일한 대면 기회입니다",
                            en:"One representative emails 2 to 3 ranked ideas, one sentence each · he asks groups to brainstorm in early September, so this weekend is the only in-person window",
                            cn:"由一名组代表将2~3个候选(各一句话并排序)邮件给教授 · 教授建议九月初头脑风暴,本周末是唯一的面对面机会" } },
        ],
      },
      {
        course:"9/11(금)", color:"#8e8a99",
        when:{ kr:"금 9/11 · STAT 첫 수업 + FNCE", en:"Fri Sep 11 · first STAT class + FNCE", cn:"周五 9/11 · STAT 首堂课 + FNCE" },
        badge:{ kr:"리딩 있음", en:"Readings", cn:"有阅读" },
        lines:[
          { icon:"📝", text:{ kr:"**STAT 6130 면제 시험** — 첫 수업 시간에 진행", en:"**STAT 6130 waiver exam** — during the first class", cn:"**STAT 6130 免修考试** — 首堂课时间进行" } },
  ...
  blockWeek: {
    ...
    options: [
      { code:"MKTG 7340", meta:"🟢 신청 가능 · SFO · 10/12–15 · Nave · ADD 10/5 · DROP·P/F 10/13 · Audit O · 대기 없음",
      ...
      { code:"MKTG 8530", meta:"🟢 신청 가능 · PHL · 10/12–15 · Karol/Norton · ADD 10/5",
        ...
        desc:{ kr:"", en:"", cn:"" } },
      { code:"MGMT 7640", meta:"🔴 **잔여 2석 / 37석** · SFO · 10/12–14 (3일) · Rosenkopf · ADD 10/5",
      ...
      { code:"LGST 7500", meta:"🟢 신청 가능 · PHL · 10/12–15 · Conti-Brown · ADD 10/5 · 30석 중 20석 여유",
        title:{ kr:"Global (Anti-)Money Laundering", en:"Global (Anti-)Money Laundering", cn:"全球反洗钱" },
        desc:{ kr:"", en:"", cn:"" } },
      { code:"OIDD 6530", meta:"🟢 신청 가능 · SFO · 10/12–15 · Katalan · ADD 10/5 · 49석 중 26석 여유 · Audit O",
        title:{ kr:"Mathematical Modeling in Finance", en:"Mathematical Modeling and its Applications in Finance", cn:"金融数学建模" },
        desc:{ kr:"", en:"", cn:"" } },
      { code:"OIDD 6140", meta:"🟡 대기 71명 · SFO · 11/30–12/3 · Netessine · ADD 11/23 · Audit ✕",
      ...
      { code:"HCMG 8600", meta:"🟢 신청 가능 · PHL · 11/30–12/3 · Nembhard · ADD 11/23 · 78석 중 58석 여유",
      ...
      { code:"LGST 6420", meta:"🟡 대기 42명 · SFO · 12/14–16 (3일) · Werbach · ADD 12/7 · DROP·P/F 12/15 · Audit ✕",
