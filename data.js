...
const DATA = {
  meta: {
    cohort: "WEMBA 52",
    lastUpdated: "2026-07-17",   // ← 업데이트할 때마다 이 날짜만 바꾸세요 (YYYY-MM-DD)
    author:   "Sally",
    tzLabel:  "PT",
  ...
  whatsNew: [
    { date:"2026-07-17", kr:"⚠️ HSC 이번 주말 수업엔 사전 리딩이 있어요 — 공지엔 없고 실라버스(v1.6)에 수업별 케이스·아티클·스터디 질문이 정리돼 있음. 케이스는 Study.Net, 질문은 실라버스. 시간 없으면 케이스+스터디 질문만 — 콜드콜 방어의 90%. 아티클은 나중에 (수업별 목록은 아래 HSC 카드)", en:"⚠️ HSC classes this weekend DO have pre-readings — not in announcements, but the syllabus (v1.6) lists cases + articles + study questions per class. Cases on Study.Net, questions in the syllabus. Short on time? Cases + study questions = 90% of cold-call defense; skim articles later (per-class list in the HSC card below)", cn:"⚠️ HSC 本周末课程有预读 — 公告里没有,大纲(v1.6)按课列出案例+文章+思考题。案例在 Study.Net,思考题在大纲。时间紧就只看案例+思考题 — 冷点名防御的90%,文章之后再补(每节课清单见下方 HSC 卡)" },
    { date:"2026-07-17", kr:"✅ BEPP 번들링·이부가격제(two-part tariff)는 미드텀 범위 **제외** — Pras 서면 확인. 둘 다 기말 토픽 (그동안의 TBC 해소!)", en:"✅ BEPP bundling & two-part tariffs are OUT of the midterm — confirmed in writing by Pras. Both are final-exam topics (the long-running TBC is finally resolved!)", cn:"✅ BEPP 捆绑与二部收费不在期中范围 — Pras 书面确认。两者均属期末主题(长期待确认终于解决!)" },
    { date:"2026-07-17", kr:"📐 BEPP 채점 규칙(TA 확인): 유도 없는 답 = 0점 · 적용 없는 개념 = 0점 · 소수점 그대로 OK(반올림 감점 없음) · 접근을 보여주면 부분점수 후함 · 기출 정오표는 BEPP 카드 참고", en:"📐 BEPP grading rules (TA-confirmed): answers without derivation = ZERO · concepts without application = ZERO · decimals are fine (no rounding penalty) · partial credit is generous if you show your approach · past-exam errata in the BEPP card", cn:"📐 BEPP 评分规则(TA确认): 无推导的答案=0分 · 无应用的概念=0分 · 小数不扣分 · 展示思路给分慷慨 · 真题勘误见 BEPP 卡" },
    { date:"2026-07-17", kr:"💰 가을 등록금 7/31 마감 — 연체료 붙습니다. 여행·휴가 중 놓치지 않기! 분납은 5개월 플랜 마감, **4개월 플랜만 7/31까지**($50 신청료 · ACH 무료, 카드 +3% · 첫 출금 8/15). 해외 은행은 PayMyTuition. Penn.Pay ▸ Payment Plans", en:"💰 Fall tuition due 7/31 — late penalty after that. Don't let it slip during travel! The 5-month plan has closed; the 4-month plan is open until 7/31 ($50 enrollment fee · ACH free, card +3% · first withdrawal 8/15). International bank → PayMyTuition. Penn.Pay ▸ Payment Plans", cn:"💰 秋季学费 7/31 截止 — 之后有滞纳金。别在旅行中错过!5个月分期已截止,**仅4个月计划开放至 7/31**($50 手续费 · ACH 免费,信用卡 +3% · 首次扣款 8/15)。海外银行用 PayMyTuition。Penn.Pay ▸ Payment Plans" },
    { date:"2026-07-17", kr:"⚠️ ACCT Quiz 6·7 마감이 조용히 연장 — 7/29 8:50 PM → **11:50 PM PT** (Canvas API 확인) · Quiz 1–5도 8/14까지 재오픈 → 기말 복습용으로 재응시 가능", en:"⚠️ ACCT Quiz 6·7 quietly extended — 7/29 8:50 PM → 11:50 PM PT (verified via Canvas API) · Quizzes 1–5 also re-opened until 8/14 → re-attempt them as final-exam review", cn:"⚠️ ACCT Quiz 6·7 悄悄延长 — 7/29 8:50 PM → 11:50 PM PT(Canvas API 核实)· Quiz 1–5 也重开至 8/14 → 可作期末复习重做" },
    { date:"2026-07-17", kr:"🎓 MGMT 6100 종강 — 기말 페이퍼·팀 발표 성적이 Canvas에 공개(코멘트 확인). TA 피드백의 5개 평가축 = Theory·Data·Analysis·Organization·Application → HSC 페이퍼도 같은 축으로 채점될 가능성 · 최종 letter grade는 Path@Penn 비공식 성적표에서 확인", en:"🎓 MGMT 6100 wrapped — final paper & team presentation grades are on Canvas (read the comments). The TA feedback lists 5 grading criteria: Theory·Data·Analysis·Organization·Application → likely the same axes for your HSC paper · final letter grades are viewable on Path@Penn (unofficial transcript)", cn:"🎓 MGMT 6100 结课 — 期末论文与团队展示成绩已在 Canvas(看评语)。TA 反馈列出5项标准: Theory·Data·Analysis·Organization·Application → HSC 论文可能同样标准 · 最终等级成绩可在 Path@Penn 非正式成绩单查看" },
    { date:"2026-07-17", kr:"🗂 행정 — ACCT 미드텀 솔루션 게시(Files ▸ Midterm Exam ▸ Midterm–2026) · 'Using AI with Excel' 워크샵 7/29 1–2 PM ET 또는 8–9 PM ET · Math Boot Camp 설문(익명, Quizzes에 · 5분) · 코호트 튜터링 시작 — Ivan C.(ivanc@wharton.upenn.edu)가 이메일로 가능 시간 공유", en:"🗂 Admin — ACCT midterm solutions posted (Files ▸ Midterm Exam ▸ Midterm–2026) · 'Using AI with Excel' workshop 7/29, 1–2 PM ET or 8–9 PM ET · Math Boot Camp survey (anonymous, in Quizzes · 5 min) · cohort tutoring is live — Ivan C. (ivanc@wharton.upenn.edu) emailed his availability", cn:"🗂 行政 — ACCT 期中答案已发(Files ▸ Midterm Exam ▸ Midterm–2026)· 'Using AI with Excel' 工作坊 7/29 1–2 PM ET 或 8–9 PM ET · Math Boot Camp 问卷(匿名,在 Quizzes · 5分钟)· 同期辅导开放 — Ivan C.(ivanc@wharton.upenn.edu)已邮件分享时间" },
    { date:"2026-07-17", kr:"📝 HSC 페이퍼(7/27, 16%) — TA Zorina Chen이 이번 주말 대면 페이퍼 미팅 진행 · 팀 페이퍼 TA 체크인(필수) 창구는 7/24 오픈(Calendly, 팀당 1슬롯) · 팁: ~1,000단어, 이론 4개 엮기, '케이스=본인 직무'", en:"📝 HSC paper (Jul 27, 16%) — TA Zorina Chen holds in-person paper meetings this weekend · the mandatory team-paper TA check-in window opens 7/24 (Calendly, 1 slot per team) · tips: ~1,000 words, weave in 4 theories, 'the case is you & your job'", cn:"📝 HSC 论文(7/27,16%)— TA Zorina Chen 本周末有线下论文面谈 · 团队论文 TA 签到(必须)窗口 7/24 开放(Calendly,每队1个)· 提示: ~1,000词、融入4个理论、'案例就是你的工作'" },
  ],
  ...
  deadlines: [
    {
      ...
      detail:{ kr:"9:30–11:30 AM · 합반 · Room 660 · 5문제/120분 · 범위 L1–8 · closed book + 자작 치트시트 1장(8.5×11 양면) · ✅번들링·이부가격제는 범위 제외(기말 토픽) · 직후 점심+Town Hall 11:45", en:"9:30–11:30 AM · joint · Room 660 · 5 problems/120 min · scope L1–8 · closed book + one self-made cheat sheet (8.5×11, both sides) · ✅ bundling & two-part tariffs are OUT of scope (final-exam topics) · lunch + Town Hall right after at 11:45", cn:"上午9:30–11:30 · 合并班 · Room 660 · 5题/120分钟 · 范围 L1–8 · 闭卷 + 自制速查表1页(8.5×11双面)· ✅捆绑与二部收费不在范围(属期末)· 随后午餐+Town Hall 11:45" },
    },
    {
      date:"2026-07-24", type:"milestone", course:"MGMT", new:true,
      title:{ kr:"팀 페이퍼 TA 체크인 창구 오픈", en:"Team-paper TA check-in window opens", cn:"团队论文 TA 签到窗口开放" },
      detail:{ kr:"7/24–8/5 사이 필수 Zoom 체크인 · 팀당 Calendly 1슬롯 → 일찍 예약할수록 좋은 시간대 확보 (리드 Zorina Chen)", en:"Mandatory Zoom check-in between 7/24–8/5 · 1 Calendly slot per team → book early for the good times (Lead Zorina Chen)", cn:"7/24–8/5 之间必须 Zoom 签到 · 每队 Calendly 1个名额 → 越早预约时段越好(组长 Zorina Chen)" },
    },
    {
    ...
    },
    {
      ...
      detail:{ kr:"⚠️ 11:50 PM PT로 연장됨(기존 8:50 PM) · 오픈 7/19 · HSC 페이퍼(7/27)와 같은 주 — 열리면 미리 처리 권장", en:"⚠️ extended to 11:50 PM PT (was 8:50 PM) · opens Jul 19 · same week as the HSC paper (7/27) — knock them out when they open", cn:"⚠️ 延至 11:50 PM PT(原 8:50 PM)· 7/19开放 · 与 HSC 论文(7/27)同周 — 开放即做" },
    },
    {
  ...
  courses: [
    {
      ...
      points:[
        ...
        { new:true, kr:"⚠️ Quiz 6·7 마감이 11:50 PM PT로 연장(기존 8:50 PM) · Quiz 1–5는 8/14까지 재오픈 → 기말 복습 삼아 재응시 가능 · Quiz 8은 오픈 8/1→마감 8/13(기말 하루 전)", en:"⚠️ Quiz 6·7 extended to 11:50 PM PT (was 8:50 PM) · Quizzes 1–5 re-opened until 8/14 → re-attempt them as final review · Quiz 8 opens 8/1 → due 8/13 (day before the final)", cn:"⚠️ Quiz 6·7 延至 11:50 PM PT(原 8:50 PM)· Quiz 1–5 重开至 8/14 → 可作期末复习重做 · Quiz 8 开8/1→截8/13(期末前一天)" },
        { new:true, kr:"미드텀 자료 완비(Files ▸ Midterm Exam ▸ Midterm–2026): 문제 PDF(23p)+풀이 docx+Quiz 1–5 통계 — 반환 시험지와 대조해 기말 전 복기 마무리", en:"Midterm set complete (Files ▸ Midterm Exam ▸ Midterm–2026): questions PDF (23p) + full solution docx + Quizzes 1–5 stats — review against your returned paper before the final", cn:"期中资料齐全(Files ▸ Midterm Exam ▸ Midterm–2026): 试题 PDF(23页)+答案 docx+Quiz 1–5 统计 — 对照返还卷,期末前复盘" },
    ...
    },
    {
      ...
      points:[
        { new:true, kr:"🎓 MGMT 6100 종강 — 기말 페이퍼·팀 발표 성적이 Canvas에 공개(코멘트 꼭 확인). TA 피드백의 **5개 평가축 = Theory · Data · Analysis · Organization · Application** → HSC 페이퍼도 같은 축으로 채점될 가능성 · 최종 letter grade는 Path@Penn 비공식 성적표에서 확인", en:"🎓 MGMT 6100 wrapped — final paper & team presentation grades are on Canvas (read the comments). The TA feedback lists 5 grading criteria: Theory · Data · Analysis · Organization · Application → likely the same axes for your HSC paper · final letter grades are on Path@Penn (unofficial transcript)", cn:"🎓 MGMT 6100 结课 — 期末论文与团队展示成绩已在 Canvas(务必看评语)。TA 反馈的**5项标准 = Theory · Data · Analysis · Organization · Application** → HSC 论文可能同样标准 · 最终等级成绩见 Path@Penn 非正式成绩单" },
        { kr:"📊 전략 페이퍼 성적·코멘트 반환(7/6) + 상세 정답 가이드('6130_Strategy Answer Guide', Files) — 점수 12.5–16(평균 ≈14.5). 내 코멘트와 대조해 읽기: 팀 기말(8/24)·Global 메모의 청사진", en:"📊 Strategy paper grades & comments are back (7/6) + a detailed answer guide ('6130_Strategy Answer Guide', Files) — scores 12.5–16 (mean ≈14.5). Read it against your comments; it's the blueprint for the team final (8/24) & Global memo", cn:"📊 战略论文成绩·评语返还(7/6)+ 详细答案指南('6130_Strategy Answer Guide', Files)— 分数 12.5–16(均分 ≈14.5)。对照自己的评语阅读: 团队期末(8/24)·Global 备忘的蓝本" },
    ...
    },
    {
      ...
      points:[
        { new:true, kr:"✅ 미드텀 범위 최종 확정 — L1–8 · closed book + 자작 치트시트 1장(8.5×11 양면) · **번들링·이부가격제(two-part tariff)는 제외**(Pras 서면 확인) · L12–14·L10–11 영상과 함께 모두 기말 토픽", en:"✅ Midterm scope final — L1–8 · closed book + one self-made cheat sheet (8.5×11, both sides) · bundling & two-part tariffs are OUT (confirmed in writing by Pras) · they join L12–14 & the L10–11 video as final-exam topics", cn:"✅ 期中范围最终确定 — L1–8 · 闭卷 + 自制速查表1页(8.5×11双面)· **捆绑与二部收费不考**(Pras 书面确认)· 与 L12–14、L10–11 视频同属期末主题" },
        { new:true, kr:"📐 채점 규칙(TA 확인): 유도 없는 답 = **0점** · 적용 없는 개념 = **0점** · 소수점 그대로 OK(반올림 감점 없음) · 접근을 보여주면 부분점수 후함", en:"📐 Grading rules (TA-confirmed): answers without derivation = ZERO · concepts without application = ZERO · decimals are fine (no rounding penalty) · partial credit is generous if you show your approach", cn:"📐 评分规则(TA确认): 无推导的答案=**0分** · 无应用的概念=**0分** · 小数可保留(不扣分)· 展示思路给分慷慨" },
        { new:true, kr:"🔧 기출 정오표 — 2023 Q1a: 중간점은 17이 아니라 **15** · 2024 Q2a: 총비용 합계 **3,260,328** · 2025 Q2b/c: 장기이윤 **$0**, 가격 **$20** · ⚠️ 오타 아님: 2025 Q3b는 가격이 **$4.20→$3.50**(문제의 숫자 그대로 읽기) · 2022 Q4c에서 Pras와 Canvas 풀이가 다르면 **Canvas가 채점 기준**", en:"🔧 Past-exam errata — 2023 Q1a: midpoint uses 15, not 17 · 2024 Q2a: total cost adds to 3,260,328 · 2025 Q2b/c: LR profit = $0, price = $20 · ⚠️ NOT a typo: 2025 Q3b the price change is $4.20→$3.50 (read the numbers as given) · 2022 Q4c: where Pras and Canvas solutions disagree, Canvas is the grading standard", cn:"🔧 真题勘误 — 2023 Q1a: 中点用 **15** 而非17 · 2024 Q2a: 总成本合计 **3,260,328** · 2025 Q2b/c: 长期利润 **$0**,价格 **$20** · ⚠️ 非笔误: 2025 Q3b 价格变化为 **$4.20→$3.50**(按题目数字)· 2022 Q4c 若 Pras 与 Canvas 答案不一致,**以 Canvas 为评分标准**" },
        ...
        { new:true, kr:"🗓 기말 준비물은 이미 다 나와 있음(토요일까지는 미뤄두기): 기출 기말 5세트(2020–24, 정답 포함 · Pras 드롭박스) + 기말 토픽 리스트(8개) + RS5 워크시트(세션 8/5 7 PM PT) · L12·13 'filled in' PDF도 기말(게임이론)용 · RS4 풀이+Inkoo 노트는 catch-up용", en:"🗓 Finals prep is already staged (park it until Saturday): 5 practice finals (2020–24 w/ answers, Pras's Dropbox) + finals topic list (8 topics) + RS5 worksheet (session 8/5, 7 PM PT) · L12·13 'filled in' PDFs are final material (game theory) · RS4 solutions + Inkoo's notes are there for catch-up", cn:"🗓 期末资料已备齐(周六前先放着): 5套期末真题(2020–24,含答案 · Pras Dropbox)+ 期末主题清单(8个)+ RS5 练习题(8/5 7 PM PT)· L12·13 'filled in' PDF 亦属期末(博弈论)· RS4 答案+Inkoo 笔记可补课" },
      ],
      traps:[
    ...
    },
    {
      ...
      headline:{ kr:"이번 주말 케이스 5개 · 페이퍼 7/27 (16%)", en:"5 cases this weekend · paper Jul 27 (16%)", cn:"本周末5个案例 · 论文 7/27 (16%)" },
      points:[
        { new:true, kr:"⚠️ 사전 리딩은 **공지가 아니라 실라버스(v1.6)**에 있음 — 수업별 케이스+아티클+스터디 질문. 케이스는 Study.Net, 질문은 실라버스. 시간 없으면 **케이스+스터디 질문만** = 콜드콜 방어의 90%, 아티클은 나중에", en:"⚠️ Pre-readings are in the syllabus (v1.6), NOT the announcements — cases + articles + study questions per class. Cases on Study.Net, questions in the syllabus. Short on time? Cases + study questions = 90% of cold-call defense; skim articles later", cn:"⚠️ 预读在**大纲(v1.6)而非公告** — 每节课的案例+文章+思考题。案例在 Study.Net,思考题在大纲。时间紧就**只看案例+思考题** = 冷点名防御的90%,文章之后再补" },
        { new:true, kr:"📗 금 #5 성과평가 — 케이스 *Naukri: Three Retention Dilemmas*(누구를 잡을까: Podar/Bose/Iyer?) + Gabarro & Hill 'Managing Performance' + Cappelli & Tavis 'The Performance Management Revolution'(HBR)", en:"📗 Fri #5 Performance Appraisal — case *Naukri: Three Retention Dilemmas* (who to retain: Podar/Bose/Iyer?) + Gabarro & Hill 'Managing Performance' + Cappelli & Tavis 'The Performance Management Revolution' (HBR)", cn:"📗 周五 #5 绩效评估 — 案例 *Naukri: Three Retention Dilemmas*(留谁: Podar/Bose/Iyer?)+ Gabarro & Hill 'Managing Performance' + Cappelli & Tavis 'The Performance Management Revolution'(HBR)" },
        { new:true, kr:"📘 금 #6 창업자의 청사진 — 케이스 *Automated Travel Systems*(스터디 질문 4개: 어떤 blueprint인가·창업자 각인 등) + Baron & Hannan 'Organizational Blueprints'(CMR)", en:"📘 Fri #6 Founder's Blueprint — case *Automated Travel Systems* (4 study Qs incl. which blueprint & founder imprint) + Baron & Hannan 'Organizational Blueprints' (CMR)", cn:"📘 周五 #6 创始人蓝图 — 案例 *Automated Travel Systems*(4道思考题: 属哪种 blueprint·创始人印记等)+ Baron & Hannan 'Organizational Blueprints'(CMR)" },
        { new:true, kr:"📙 토 #7 AI와 일 — **케이스 2개**: *Deluge of Documents*(CFO 설득, IRR ~20% · 월 인건비 $200K 계산) + *AI Scribe @ Mass General Brigham*(라이선스 200개 배분 · 왜 전면 도입이 아닌가?)", en:"📙 Sat #7 AI & Work — TWO cases: *Deluge of Documents* (pitch the CFO at ~20% IRR; $200K/month payroll math) + *AI Scribe @ Mass General Brigham* (allocate 200 licenses; why isn't it a straight rollout?)", cn:"📙 周六 #7 AI 与工作 — **两个案例**: *Deluge of Documents*(说服 CFO,IRR ~20% · 月薪$200K 计算)+ *AI Scribe @ Mass General Brigham*(分配200个许可 · 为何不能直接全面推行?)" },
        { new:true, kr:"📕 토 #8 인사–전략 정합 — 케이스 *Southwest Airlines: HR for Competitive Advantage* + Pfeffer 'Producing Sustainable Competitive Advantage Through the Effective Management of People'", en:"📕 Sat #8 People–Strategy Alignment — case *Southwest Airlines: HR for Competitive Advantage* + Pfeffer 'Producing Sustainable Competitive Advantage Through the Effective Management of People'", cn:"📕 周六 #8 人力–战略匹配 — 案例 *Southwest Airlines: HR for Competitive Advantage* + Pfeffer 'Producing Sustainable Competitive Advantage Through the Effective Management of People'" },
        { new:true, kr:"🗣 TA Zorina Chen이 이번 주말 **대면 HSC 페이퍼 미팅** 진행 — 페이퍼 방향 잡기 좋은 기회", en:"🗣 TA Zorina Chen holds in-person HSC-paper meetings this weekend — a good chance to sanity-check your angle", cn:"🗣 TA Zorina Chen 本周末有**线下 HSC 论文面谈** — 校准论文方向的好机会" },
        { kr:"페이퍼 팁(수업에서 직접): ~1,000단어 · 이론 4개를 층층이 녹여서(나열·미인대회 X) · \"케이스는 나와 내 직무\" · 길게 쓰고 줄이기 · ⚠️ MGMT 6100의 5개 평가축(Theory·Data·Analysis·Organization·Application)으로 채점될 가능성", en:"Paper tips (straight from class): ~1,000 words · weave in 4 theories in layers (not a list / beauty contest) · \"the case is you and your job\" · draft long then cut · ⚠️ likely graded on MGMT 6100's 5 criteria (Theory·Data·Analysis·Organization·Application)", cn:"论文提示(课上原话): ~1,000字 · 4个理论层层融入(非罗列/选美)· \"案例就是你和你的工作\" · 先写长再精简 · ⚠️ 可能按 MGMT 6100 的5项标准评分(Theory·Data·Analysis·Organization·Application)" },
  ...
  actions:[
    { id:"a17", by:"2026-07-18", label:{ kr:"HSC 주말 케이스 읽기 — 금 Naukri · 금 Automated Travel Systems · 토 Deluge of Documents + AI Scribe · 토 Southwest (케이스+스터디 질문 우선)", en:"Read the HSC weekend cases — Fri Naukri · Fri Automated Travel Systems · Sat Deluge of Documents + AI Scribe · Sat Southwest (cases + study questions first)", cn:"读 HSC 周末案例 — 周五 Naukri · 周五 Automated Travel Systems · 周六 Deluge of Documents + AI Scribe · 周六 Southwest(优先案例+思考题)" } },
    { id:"a18", by:"2026-07-27", label:{ kr:"HSC 페이퍼 작성 (7/27 마감, 16%) · 주말에 TA Zorina Chen 대면 미팅 활용", en:"Write the HSC paper (due 7/27, 16%) · use TA Zorina Chen's in-person meetings this weekend", cn:"写 HSC 论文(7/27 截止,16%)· 利用周末 TA Zorina Chen 的面谈" } },
    { id:"a19", by:"2026-07-29", label:{ kr:"ACCT Quiz 6·7 완료 — 7/29 11:50 PM PT (연장됨)", en:"Finish ACCT Quiz 6·7 — 7/29, 11:50 PM PT (extended)", cn:"完成 ACCT Quiz 6·7 — 7/29 11:50 PM PT(已延长)" } },
    ...
    { id:"a8", by:"2026-08-05", label:{ kr:"팀 페이퍼 TA 체크인 — 창구 7/24 오픈, 팀 배정 TA 확인 후 Calendly 예약(팀당 1개), 8/5까지", en:"Team-paper TA check-in — window opens 7/24; confirm our team's TA, then book on Calendly (1 per team), by Aug 5", cn:"团队论文 TA 签到 — 窗口 7/24 开放,确认本队 TA 后用 Calendly 预约(每队1个),8/5前" } },
  ],
  ...
  schedule: {
        ...
        days: [
          {
            ...
            rows: [
              ...
              { time:"1:00–4:00",   s1:{ kr:"ACCT 6130 · Lambert · Room 615", en:"ACCT 6130 · Lambert · Room 615", cn:"ACCT 6130 · Lambert · Room 615", read:{ kr:"슬라이드·핸드아웃: Files ▸ 세션 번호 폴더(01–21) · 미드텀 이후 = 감가상각·장기자산(기말 범위 본격화)", en:"Slides & handouts: Files ▸ numbered session folders (01–21) · post-midterm = depreciation & long-lived assets (final-exam territory)", cn:"幻灯·讲义: Files ▸ 课时编号文件夹(01–21)· 期中后 = 折旧与长期资产(进入期末范围)" } }, s2:{ kr:"MGMT/HSC 6130 · MacDuffie · Room 612", en:"MGMT/HSC 6130 · MacDuffie · Room 612", cn:"MGMT/HSC 6130 · MacDuffie · Room 612", read:{ kr:"HSC #5 Naukri (성과평가) · #6 Automated Travel Systems (창업자 청사진)", en:"HSC #5 Naukri (Performance Appraisal) · #6 Automated Travel Systems (Founder's Blueprint)", cn:"HSC #5 Naukri(绩效评估)· #6 Automated Travel Systems(创始人蓝图)" } } },
              { time:"4:15–7:15",   s1:{ kr:"MGMT/HSC 6130 · MacDuffie · Room 612", en:"MGMT/HSC 6130 · MacDuffie · Room 612", cn:"MGMT/HSC 6130 · MacDuffie · Room 612", read:{ kr:"HSC #5 Naukri (성과평가) · #6 Automated Travel Systems (창업자 청사진)", en:"HSC #5 Naukri (Performance Appraisal) · #6 Automated Travel Systems (Founder's Blueprint)", cn:"HSC #5 Naukri(绩效评估)· #6 Automated Travel Systems(创始人蓝图)" } }, s2:{ kr:"ACCT 6130 · Lambert · Room 615", en:"ACCT 6130 · Lambert · Room 615", cn:"ACCT 6130 · Lambert · Room 615", read:{ kr:"슬라이드·핸드아웃: Files ▸ 세션 번호 폴더(01–21) · 미드텀 이후 = 감가상각·장기자산(기말 범위 본격화)", en:"Slides & handouts: Files ▸ numbered session folders (01–21) · post-midterm = depreciation & long-lived assets (final-exam territory)", cn:"幻灯·讲义: Files ▸ 课时编号文件夹(01–21)· 期中后 = 折旧与长期资产(进入期末范围)" } } },
          ...
          },
          {
            ...
            rows: [
              { time:"8:00–9:00",   both:{ kr:"조식 · Dining Room", en:"Breakfast · Dining Room", cn:"早餐 · Dining Room" } },
              { time:"9:00–12:00",  s1:{ kr:"MGMT/HSC 6130 · MacDuffie · Room 612", en:"MGMT/HSC 6130 · MacDuffie · Room 612", cn:"MGMT/HSC 6130 · MacDuffie · Room 612", read:{ kr:"HSC #7 케이스 2개: Deluge of Documents + AI Scribe (AI와 일) · #8 Southwest Airlines (인사–전략 정합)", en:"HSC #7 two cases: Deluge of Documents + AI Scribe (AI & Work) · #8 Southwest Airlines (People–Strategy Alignment)", cn:"HSC #7 两个案例: Deluge of Documents + AI Scribe(AI 与工作)· #8 Southwest Airlines(人力–战略匹配)" } }, s2:{ kr:"ACCT 6130 · Lambert · Room 615", en:"ACCT 6130 · Lambert · Room 615", cn:"ACCT 6130 · Lambert · Room 615", read:{ kr:"슬라이드·핸드아웃: Files ▸ 세션 번호 폴더(01–21) · 미드텀 이후 = 감가상각·장기자산(기말 범위 본격화)", en:"Slides & handouts: Files ▸ numbered session folders (01–21) · post-midterm = depreciation & long-lived assets (final-exam territory)", cn:"幻灯·讲义: Files ▸ 课时编号文件夹(01–21)· 期中后 = 折旧与长期资产(进入期末范围)" } } },
              { time:"12:00–1:00",  both:{ kr:"중식 · Dining Room", en:"Lunch · Dining Room", cn:"午餐 · Dining Room" } },
              { time:"1:00–4:00",   s1:{ kr:"ACCT 6130 · Lambert · Room 615", en:"ACCT 6130 · Lambert · Room 615", cn:"ACCT 6130 · Lambert · Room 615", read:{ kr:"슬라이드·핸드아웃: Files ▸ 세션 번호 폴더(01–21) · 미드텀 이후 = 감가상각·장기자산(기말 범위 본격화)", en:"Slides & handouts: Files ▸ numbered session folders (01–21) · post-midterm = depreciation & long-lived assets (final-exam territory)", cn:"幻灯·讲义: Files ▸ 课时编号文件夹(01–21)· 期中后 = 折旧与长期资产(进入期末范围)" } }, s2:{ kr:"MGMT/HSC 6130 · MacDuffie · Room 612", en:"MGMT/HSC 6130 · MacDuffie · Room 612", cn:"MGMT/HSC 6130 · MacDuffie · Room 612", read:{ kr:"HSC #7 케이스 2개: Deluge of Documents + AI Scribe (AI와 일) · #8 Southwest Airlines (인사–전략 정합)", en:"HSC #7 two cases: Deluge of Documents + AI Scribe (AI & Work) · #8 Southwest Airlines (People–Strategy Alignment)", cn:"HSC #7 两个案例: Deluge of Documents + AI Scribe(AI 与工作)· #8 Southwest Airlines(人力–战略匹配)" } } },
            ],
          },
        ],
      },
    ...
    notes: [
      ...
      { kr:"📖 = 그 수업 자료·사전 케이스 (HSC 케이스=Study.Net·질문=실라버스 v1.6 · ACCT 슬라이드·핸드아웃=Files 세션 폴더). 상세는 과목 카드·Resource map 참고", en:"📖 = that session's materials / pre-class cases (HSC cases = Study.Net, questions = syllabus v1.6 · ACCT slides & handouts = Files session folders). More in the course cards & Resource map", cn:"📖 = 该节课的资料·课前案例(HSC 案例=Study.Net·思考题=大纲 v1.6 · ACCT 幻灯·讲义=Files 课时文件夹)。详情见科目卡与 Resource map" },
