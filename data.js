...
const DATA = {
  ...
  canvasMap:[
    {
      ...
      watch:{ kr:"🆕 기말 기출 2021–25(정답 포함)는 이제 Canvas에도 게시(2025 신규) · Pras 세션6(이부가격·번들링)·세션7(과점) 슬라이드+영상(async/live) · 기말 토픽 리스트(8개)·RS5 워크시트 · 미드텀 기출·드롭박스 자료도 유효 · 건너뛴 토픽은 Class Recordings · Inkoo는 공지를 조용히 수정", en:"🆕 Past finals 2021–25 (w/ answers) now on Canvas too (2025 new) · Pras Session 6 (two-part tariffs + bundling) & Session 7 (oligopoly) slides + video (async/live) · finals topic list (8) · RS5 worksheet · midterm past exams & Dropbox set still valid · skipped topics in Class Recordings · Inkoo edits announcements silently", cn:"🆕 期末真题 2021–25(含答案)现也在 Canvas(2025 新增)· Pras 第6课(二部收费+捆绑)·第7课(寡头)幻灯+视频(async/live)· 期末主题清单(8个)·RS5 练习题 · 期中真题与 Dropbox 资料仍有效 · 跳过的内容看 Class Recordings · Inkoo 会悄悄改公告" },
    },
    {
      subject:"ACCT",
      where:{ kr:"Files > 세션별 번호 폴더 01–21 (핸드아웃+케이스 풀이) · 🆕 신규 덱: Income Taxes·Shareholders' Equity·Investments in Financial Assets + Transfer Pricing(TP) 슬라이드(Quiz 6 대비) · 미드텀 세트는 Files ▸ Midterm Exam ▸ Midterm–2026", en:"Files > numbered session folders 01–21 (handouts + case solutions) · 🆕 new decks: Income Taxes · Shareholders' Equity · Investments in Financial Assets + Transfer Pricing (TP) slides (for Quiz 6) · midterm set in Files ▸ Midterm Exam ▸ Midterm–2026", cn:"Files > 各课时编号文件夹 01–21(讲义+案例答案)· 🆕 新讲义: Income Taxes·Shareholders' Equity·Investments in Financial Assets + Transfer Pricing(TP)幻灯(备 Quiz 6)· 期中资料在 Files ▸ Midterm Exam ▸ Midterm–2026" },
    ...
    },
    {
      ...
      watch:{ kr:"프레임 ADDING·CAGE·AAA·BBB(각 25%) · ⚠️ 외부 리서치 금지·AI는 전체 프롬프트 부록 공개 · TA Na Hyun Kim: 대면 7/31–8/1(Office 675)+온라인 8/3–7(Calendly)", en:"Frameworks ADDING·CAGE·AAA·BBB (25% each) · ⚠️ no outside research · AI must disclose full prompts in an appendix · TA Na Hyun Kim: in-person 7/31–8/1 (Office 675) + virtual 8/3–7 (Calendly)", cn:"框架 ADDING·CAGE·AAA·BBB(各25%)· ⚠️ 禁外部研究·用 AI 须附录公开完整提示词 · TA Na Hyun Kim: 线下 7/31–8/1(Office 675)+线上 8/3–7(Calendly)" },
    },
    {
  ...
  schedule: {
    ...
    notes: [
      { kr:"⚠️ 시작 시각이 매일 다름! 목 9:30 · 금 8:30 · 토 9:00 — 꼭 확인 · 위는 섹션 1·2를 나눠서 표기(순서 반대), 강의실은 공식 Weekend Schedule 폴더에서 본인 섹션 확인", en:"⚠️ Start time differs each day! Thu 9:30 · Fri 8:30 · Sat 9:00 — double-check · Sections 1 & 2 shown separately (reversed order), confirm your section & rooms in the official Weekend Schedule folder", cn:"⚠️ 每天开始时间不同!周四 9:30 · 周五 8:30 · 周六 9:00 — 务必确认 · 上表已分第1/2班(顺序相反),教室请在官方 Weekend Schedule 文件夹按班确认" },
