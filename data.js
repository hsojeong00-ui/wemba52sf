...
const DATA = {
  ...
  prep: {
    ...
    note: {
      kr:"🔴 **FNCE Quiz #1 이 이미 열려 있습니다** (8/30 공개 · **9/10(목) 23:59 PT 마감**). 그리고 교수가 **시도 3회 · 최고점 반영 · 정오답 확인 가능**으로 규칙을 바꿨습니다 — 사실상 학습 도구입니다. 📄 **여름 과목 채점본도 올라오기 시작했는데 알림이 가지 않습니다.**",
      en:"🔴 **FNCE Quiz #1 is already open** (posted Aug 30, **due Thu Sep 10, 11:59 PM PT**). The professor changed the rules to **three attempts, highest score counts, and you can see which answers were right** — effectively a study tool. 📄 **Summer course grades are also being posted, but no notifications are sent.**",
      cn:"🔴 **FNCE Quiz #1 已开放**(8/30 发布,**9/10(周四)23:59 PT 截止**)。教授已改为 **可考3次 · 取最高分 · 可查看对错** — 实为学习工具。📄 **暑期课程成绩也已陆续公布,但不会发送通知。**" },
    cards: [
      {
      ...
      {
        course:"여름 과목", color:"#ffd98a",
        when:{ kr:"지금 · 알림이 오지 않습니다", en:"Now — no notification is sent", cn:"现在 · 不会有通知" },
        badge:{ kr:"성적 공개", en:"Grades posted", cn:"成绩公布" },
        lines:[
          { icon:"📄", text:{ kr:"**BEPP 미시 기말 채점본**과 **Ethics 페이퍼 성적**이 올라오기 시작했습니다",
                              en:"**Graded micro finals** and **Ethics paper grades** have started appearing",
                              cn:"**微观经济期末批改稿**与 **Ethics 论文成绩**已开始公布" },
                     sub:{ kr:"순차 공개로 보입니다 — 아직 안 보여도 며칠 기다려 보세요", en:"They appear to be released in batches, so give it a few days if yours is not up", cn:"似为分批公布,若尚未显示可再等几日" } },
          { icon:"🔍", text:{ kr:"**Canvas ▸ All Courses ▸ Past Enrollments ▸ 과목 ▸ Grades** · 기말 항목의 **코멘트**에 채점본이 첨부돼 있습니다",
                              en:"**Canvas ▸ All Courses ▸ Past Enrollments ▸ course ▸ Grades** — the marked-up copy is attached as a **comment** on the final",
                              cn:"**Canvas ▸ All Courses ▸ Past Enrollments ▸ 课程 ▸ Grades** — 批改稿作为期末项目的**评论**附上" },
                     sub:{ kr:"⚠️ 여름 과목이 past 로 내려가면서 **알림 메일이 발송되지 않습니다.** 직접 들어가 보셔야 합니다", en:"⚠️ Once summer courses move to past enrollments, **no notification email is sent.** You have to go look", cn:"⚠️ 暑期课程移至 past 后**不再发送通知邮件**,须自行查看" } },
        ],
      },
      {
  ...
  changelog: [
    ...
    { date:"2026-08-29", items:[
      ...
      { kr:"🎯 **Innovation 대기 순번이 올라갔습니다 — 70명 중 13번** (직전 74명 중 17번). 🏥 그리고 **헬스케어 전공·집중을 고려하는 분**은 9/2 까지 이메일하면 9/11–12 주말에 열리는 Deputy Vice Dean 피드백 세션에 초대받습니다 (관심자만 해당)",
        en:"🎯 **The Innovation waitlist moved up — 13th of 70** (previously 17th of 74). 🏥 Separately, **anyone considering a Healthcare Management major or concentration** can email by Sep 2 to be invited to a feedback session with the Deputy Vice Dean on the Sep 11–12 weekend (only if interested)",
        cn:"🎯 **Innovation 候补前进 — 70人中第13位**(此前74人中第17位)。🏥 另外,**有意主修或辅修医疗管理者**可在 9/2 前发邮件,以受邀参加 9/11–12 周末的副院长反馈座谈(仅限有兴趣者)" },
  ...
  deadlines: [
    ...
    {
      date:"2026-08-28T09:00", type:"paper", course:"LGST", hard:true, new:true,
    ...
    },
    {
      ...
      detail:{ kr:"OIDD 6140 Innovation(SFO) · HCMG 8600(PHL) · ⚠️ **Innovation 은 대기 13번(70명 중)**이고 **Audit 도 불가** — 이 시각까지 자리가 안 나면 수강 불가",
              en:"OIDD 6140 Innovation (SFO) · HCMG 8600 (PHL) · ⚠️ **Innovation is 13th of 70 waitlisted** and **audit is not allowed** — no seat by this moment means you are out",
              cn:"OIDD 6140 Innovation(SFO)· HCMG 8600(PHL)· ⚠️ **Innovation 候补第13位(共70人)**且**不可旁听** — 到此时刻无空位即无法修读" },
    },
    {
    ...
    {
      date:"2026-09-12", type:"session", course:"FNCE", new:true,
    ...
    {
      date:"2026-12-05", type:"exam", course:"FNCE", hard:true, new:true,
    ...
    {
      date:"2026-10-04T23:59", type:"quiz", course:"FNCE", hard:true, new:true,
    ...
    {
      date:"2026-10-08", type:"exam", course:"FNCE", hard:true, new:true,
    ...
    {
      date:"2026-11-05T23:59", type:"quiz", course:"FNCE", hard:true, new:true,
    ...
    {
      date:"2026-11-29T23:59", type:"quiz", course:"FNCE", hard:true, new:true,
    ...
    {
      date:"2026-12-04", type:"exam", course:"FNCE", hard:true, new:true,
  ...
  blockWeek: {
    ...
    options: [
      ...
      { code:"OIDD 6530", meta:"🟢 신청 가능 · SFO · 10/12–15 · Katalan · ADD 10/5 · Audit O",
        ...
        desc:{ kr:"", en:"", cn:"" } },
      { code:"OIDD 6140", meta:"🟡 대기 13번 / 70명 · SFO · 11/30–12/3 · Netessine · ADD 11/23 · Audit ✕",
